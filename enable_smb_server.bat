...
reg ADD "HKLM\SYSTEM\CurrentControlSet\Services\srv2" /f /v "Start" /t REG_DWORD /d 3
reg ADD "HKLM\SYSTEM\CurrentControlSet\Services\srvnet" /f /v "Start" /t REG_DWORD /d 3
