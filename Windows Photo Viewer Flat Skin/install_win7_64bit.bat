...
copy /Y "%~dp0Windows 7 64 bit\Program Files (x86)\Windows Photo Viewer\PhotoViewer.dll" "C:\Program Files (x86)\Windows Photo Viewer\PhotoViewer.dll"
...
copy /Y "%~dp0Windows 7 64 bit\Program Files\Windows Photo Viewer\PhotoViewer.dll" "C:\Program Files\Windows Photo Viewer\PhotoViewer.dll"
